...
- **Предустановленные и пользовательские настройки сжатия:** Пользователи могут выбрать предустановленный размер для Discord (10 МБ) или указать пользовательский целевой размер для сжатия.
